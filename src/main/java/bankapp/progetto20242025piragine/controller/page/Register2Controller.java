...
public class Register2Controller extends RegisterController {
    ...
    public void loadRegisterPage2() //loading the register page n.2
    {
        ...
        {
            user.setAddress(streetRegisterTextField.getText()); //setting the address parameter to the User obj
            user.setCap(CapTextField1.getText()); //setting the cap parameter to the User obj
            user.setState(stateRegisterTextField.getText()); //setting the state parameter to the User obj
            user.setProvince(provinceRegisterTextField.getText()); //setting the province parameter to the User obj
            user.setCity(cityRegisterTextField1.getText()); //setting the province parameter to the User obj
            user.setStreetNumber(houseNumberDayRegisterTextField.getText()); //setting the street number parameter to the User obj
